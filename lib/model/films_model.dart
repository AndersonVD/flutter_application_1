...
List<FilmsModel> filmsModelFromJson(String str) =>
    List<FilmsModel>.from(json.decode(str).map((x) => FilmsModel.fromJson(x)));

String filmsModelToJson(List<FilmsModel> data) =>
